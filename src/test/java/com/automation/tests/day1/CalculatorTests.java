...
public class CalculatorTests {
    ...
    public void test1() throws Exception {
        ...
        desiredCapabilities.setCapability(MobileCapabilityType.DEVICE_NAME,"Pixel_2_API_24_2");
        ...
        //WebElement delete=driver.findElementByAccessibilityId("delete"); -- yukardaki ile aynı
        ...
        equals.click();//click on =

        String actual=result.getText();// get the text of result
